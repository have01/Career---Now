                    ...
                    <div class="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0">
                        <div class="">
                            ...
                            <form class="space-y-4 md:space-y-2" action="#">
                                ...
                                <button type="submit" class="w-[413px] h-[43px] bg-[#4A96FF] rounded-sm text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium  text-sm px-5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Login Now</button>
